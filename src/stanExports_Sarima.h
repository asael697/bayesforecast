...
class model_Sarima
  : public stan::model::model_base_crtp<model_Sarima> {
private:
        int n;
        int n1;
        int p;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("sar0", "P", P);
            num_params_r__ += P;
            current_statement_begin__ = 36;
            validate_non_negative_index("sma0", "Q", Q);
            num_params_r__ += Q;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 35;
        if (!(context__.contains_r("sar0")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sar0 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sar0");
        pos__ = 0U;
        validate_non_negative_index("sar0", "P", P);
        context__.validate_dims("parameter initialization", "sar0", "vector_d", context__.to_vec(P));
        Eigen::Matrix<double, Eigen::Dynamic, 1> sar0(P);
        size_t sar0_j_1_max__ = P;
        for (size_t j_1__ = 0; j_1__ < sar0_j_1_max__; ++j_1__) {
            sar0(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lub_unconstrain(-(1), 1, sar0);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sar0: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 36;
        if (!(context__.contains_r("sma0")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sma0 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sma0");
        pos__ = 0U;
        validate_non_negative_index("sma0", "Q", Q);
        context__.validate_dims("parameter initialization", "sma0", "vector_d", context__.to_vec(Q));
        Eigen::Matrix<double, Eigen::Dynamic, 1> sma0(Q);
        size_t sma0_j_1_max__ = Q;
        for (size_t j_1__ = 0; j_1__ < sma0_j_1_max__; ++j_1__) {
            sma0(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lub_unconstrain(-(1), 1, sma0);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sma0: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 35;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> sar0;
            (void) sar0;  // dummy to suppress unused var warning
            if (jacobian__)
                sar0 = in__.vector_lub_constrain(-(1), 1, P, lp__);
            else
                sar0 = in__.vector_lub_constrain(-(1), 1, P);
            current_statement_begin__ = 36;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> sma0;
            (void) sma0;  // dummy to suppress unused var warning
            if (jacobian__)
                sma0 = in__.vector_lub_constrain(-(1), 1, Q, lp__);
            else
                sma0 = in__.vector_lub_constrain(-(1), 1, Q);
            ...
            validate_non_negative_index("sar", "P", P);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> sar(P);
            stan::math::initialize(sar, DUMMY_VAR__);
            stan::math::fill(sar, DUMMY_VAR__);
            current_statement_begin__ = 46;
            validate_non_negative_index("sma", "Q", Q);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> sma(Q);
            stan::math::initialize(sma, DUMMY_VAR__);
            stan::math::fill(sma, DUMMY_VAR__);
            ...
            for (int i = 1; i <= p; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(prior_ar, i, 4, "prior_ar", 1), 1))) {
                    ...
                    stan::model::assign(ar, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                ((2 * stan::math::fabs(get_base1(ar0, i, "ar0", 1))) - 1), 
                                "assigning variable ar");
                }
            }
            ...
            for (int i = 1; i <= q; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(prior_ma, i, 4, "prior_ma", 1), 1))) {
                    ...
                    stan::model::assign(ma, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                ((2 * stan::math::fabs(get_base1(ma0, i, "ma0", 1))) - 1), 
                                "assigning variable ma");
                }
            }
            ...
            for (int i = 1; i <= P; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(prior_sar, i, 4, "prior_sar", 1), 1))) {
                    ...
                    stan::model::assign(sar, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                get_base1(sar0, i, "sar0", 1), 
                                "assigning variable sar");
                } else {
                    current_statement_begin__ = 67;
                    stan::model::assign(sar, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                ((2 * stan::math::fabs(get_base1(sar0, i, "sar0", 1))) - 1), 
                                "assigning variable sar");
                }
            }
            ...
            for (int i = 1; i <= Q; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(prior_sma, i, 4, "prior_sma", 1), 1))) {
                    ...
                    stan::model::assign(sma, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                get_base1(sma0, i, "sma0", 1), 
                                "assigning variable sma");
                } else {
                    current_statement_begin__ = 71;
                    stan::model::assign(sma, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                ((2 * stan::math::fabs(get_base1(sma0, i, "sma0", 1))) - 1), 
                                "assigning variable sma");
                }
            }
                ...
                if (as_bool(logical_gt(P, 0))) {
                    ...
                    for (int j = 1; j <= P; ++j) {
                        ...
                        if (as_bool(logical_gt(i, (period * j)))) {
                            ...
                            stan::model::assign(mu, 
                                        stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                        (stan::model::rvalue(mu, stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), "mu") + (get_base1(y, (i - (period * j)), "y", 1) * get_base1(sar, j, "sar", 1))), 
                                        "assigning variable mu");
                        }
                    }
                }
                ...
                if (as_bool(logical_gt(Q, 0))) {
                    ...
                    for (int j = 1; j <= Q; ++j) {
                        ...
                        if (as_bool(logical_gt(i, (period * j)))) {
                            ...
                            stan::model::assign(mu, 
                                        stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                        (stan::model::rvalue(mu, stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), "mu") + (get_base1(epsilon, (i - (period * j)), "epsilon", 1) * get_base1(sma, j, "sma", 1))), 
                                        "assigning variable mu");
                        }
                    }
                }
            ...
            current_statement_begin__ = 46;
            size_t sma_j_1_max__ = Q;
            for (size_t j_1__ = 0; j_1__ < sma_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(sma(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: sma" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable sma: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 49;
            ...
            if (as_bool(logical_gt(P, 0))) {
                ...
                for (int i = 1; i <= P; ++i) {
                    ...
                    if (as_bool(logical_eq(get_base1(prior_sar, i, 4, "prior_sar", 1), 1))) {
                        current_statement_begin__ = 162;
                        lp_accum__.add(normal_log(get_base1(sar0, i, "sar0", 1), get_base1(prior_sar, i, 1, "prior_sar", 1), get_base1(prior_sar, i, 2, "prior_sar", 1)));
                    } else if (as_bool(logical_eq(get_base1(prior_sar, i, 4, "prior_sar", 1), 2))) {
                        current_statement_begin__ = 163;
                        lp_accum__.add(beta_log(stan::math::fabs(get_base1(sar0, i, "sar0", 1)), get_base1(prior_sar, i, 1, "prior_sar", 1), get_base1(prior_sar, i, 2, "prior_sar", 1)));
                    } else if (as_bool(logical_eq(get_base1(prior_sar, i, 4, "prior_sar", 1), 3))) {
                        current_statement_begin__ = 164;
                        lp_accum__.add(uniform_log(get_base1(sar0, i, "sar0", 1), get_base1(prior_sar, i, 1, "prior_sar", 1), get_base1(prior_sar, i, 2, "prior_sar", 1)));
                    }
                }
            }
            ...
            if (as_bool(logical_gt(Q, 0))) {
                ...
                for (int i = 1; i <= Q; ++i) {
                    ...
                    if (as_bool(logical_eq(get_base1(prior_sma, i, 4, "prior_sma", 1), 1))) {
                        current_statement_begin__ = 170;
                        lp_accum__.add(normal_log(get_base1(sma0, i, "sma0", 1), get_base1(prior_sma, i, 1, "prior_sma", 1), get_base1(prior_sma, i, 2, "prior_sma", 1)));
                    } else if (as_bool(logical_eq(get_base1(prior_sma, i, 4, "prior_sma", 1), 2))) {
                        current_statement_begin__ = 171;
                        lp_accum__.add(beta_log(stan::math::fabs(get_base1(sma0, i, "sma0", 1)), get_base1(prior_sma, i, 1, "prior_sma", 1), get_base1(prior_sma, i, 2, "prior_sma", 1)));
                    } else if (as_bool(logical_eq(get_base1(prior_sma, i, 4, "prior_sma", 1), 3))) {
                        current_statement_begin__ = 172;
                        lp_accum__.add(uniform_log(get_base1(sma0, i, "sma0", 1), get_base1(prior_sma, i, 1, "prior_sma", 1), get_base1(prior_sma, i, 2, "prior_sma", 1)));
                    }
                }
            }
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("sar0");
        names__.push_back("sma0");
        names__.push_back("ar");
        names__.push_back("ma");
        names__.push_back("sar");
        names__.push_back("sma");
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> sar0 = in__.vector_lub_constrain(-(1), 1, P);
        size_t sar0_j_1_max__ = P;
        for (size_t j_1__ = 0; j_1__ < sar0_j_1_max__; ++j_1__) {
            vars__.push_back(sar0(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, 1> sma0 = in__.vector_lub_constrain(-(1), 1, Q);
        size_t sma0_j_1_max__ = Q;
        for (size_t j_1__ = 0; j_1__ < sma0_j_1_max__; ++j_1__) {
            vars__.push_back(sma0(j_1__));
        }
        double lp__ = 0.0;
        ...
        try {
            ...
            current_statement_begin__ = 45;
            validate_non_negative_index("sar", "P", P);
            Eigen::Matrix<double, Eigen::Dynamic, 1> sar(P);
            stan::math::initialize(sar, DUMMY_VAR__);
            stan::math::fill(sar, DUMMY_VAR__);
            current_statement_begin__ = 46;
            validate_non_negative_index("sma", "Q", Q);
            Eigen::Matrix<double, Eigen::Dynamic, 1> sma(Q);
            stan::math::initialize(sma, DUMMY_VAR__);
            stan::math::fill(sma, DUMMY_VAR__);
            current_statement_begin__ = 49;
            validate_non_negative_index("mu", "n1", n1);
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < sar0_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "sar0" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t sma0_j_1_max__ = Q;
        for (size_t j_1__ = 0; j_1__ < sma0_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "sma0" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        if (!include_gqs__ && !include_tparams__) return;
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < sma_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "sma" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t mu_j_1_max__ = n1;
            for (size_t j_1__ = 0; j_1__ < mu_j_1_max__; ++j_1__) {

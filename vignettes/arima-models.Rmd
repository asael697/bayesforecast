...
<li> Choose a model and check the residuals from your chosen model by plotting the ACF of the residuals.
<li>If residuals look like white noise, we calculate the forecasts; otherwise, we choose another model, an adaptation of the Hyndman process and not the whole process as such since, in Bayesian statistics, the AIC and BIC are not commonly used.</li>
</ol> 
Graphing the data:
...
Finally, we make a prediction of the model for the following year:
